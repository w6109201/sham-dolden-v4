    ...
    try {
        ...
        projects.forEach(project => {
            ...
            const isFeatured = project.featured === true || project.featured === 1 || project.featured === "1"
                ? `<span class="featured-badge" style="position:absolute; top:10px; right:10px; background:#d4af37; color:#000; padding:3px 10px; font-size:11px; font-weight:bold; border-radius:10px; z-index:2;">⭐ مميز</span>`
                : '';
            ...
            <div class="project-card ${isFeatured ? 'featured-card-item' : ''}">
                ...
                <div class="project-info">
                    ...
                    <div class="project-actions">
                        <a class="details-btn" href="product-details.html?id=${project.id}">
                            <i class="fa-solid fa-eye"></i> التفاصيل
                        </a>
                        <a class="whatsapp-btn" target="_blank" 
                           href="bot.html?model=${encodeURIComponent(project.title || '')}">
