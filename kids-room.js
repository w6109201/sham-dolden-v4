      ...
      <div class="project-card">
        ...
        <div class="project-card-body">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px;margin-top:8px;">
            ...
            <a data-contact-link="whatsapp" href="https://wa.me/${phone}?text=${waText}" target="_blank" class="card-btn" style="font-size:0.75rem;padding:10px 4px;text-align:center;"><i class="fa-brands fa-whatsapp"></i> واتساب</a>
